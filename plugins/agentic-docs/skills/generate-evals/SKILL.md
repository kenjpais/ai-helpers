...
auto_invoke_after: agentic-docs:create
---

# Agentic-Docs: Generate Evals

**Trigger**: `/agentic-docs:generate-evals` or automatically after `/agentic-docs:create`  
...
Automatically invoked at the end of `/agentic-docs:create`
...
Ensure:
  • Repository has CLAUDE.md or ai-docs/
  • Repository contains code to analyze
